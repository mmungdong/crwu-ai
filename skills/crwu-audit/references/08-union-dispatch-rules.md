...
| method | `资产基础法` | `03-评估方法/00-评估方法准则2019-精编/评估方法准则2019-精编条目/04-成本法`、`03-评估方法/03-资产基础法/`、`06-规则库/清单-M-资产基础法/` |
...
4. 市场法通用资料、跨方法缺陷与房地产方法专项清单均由本节按实际画像装配；资产叶子不得无条件重复持有。`06-规则库/易错点库/`
   由公共通用准则技能恒装配。`06-规则库/清单-M-成本法/` 只由本节的 `成本法` ∧ `房地产` 跨轴映射装配，不得以资产基础法清单替代
