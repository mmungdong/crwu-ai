...
- [x] **Step 2: Define manifest entry semantics**
...
- [x] **Step 3: Update manifest provenance**
...
- [x] **Step 1: Replace source-boundary wording**
...
- [x] **Step 2: Align every assembly table**
...
- [x] **Step 3: Preserve the existing user modification**
...
- [x] **Step 1: Update the live-KB protocol**
...
- [x] **Step 2: Update the DWS design**
...
- [x] **Step 3: Append a changelog entry**
...
- [x] **Step 1: Validate affected Skills**
...
- [x] **Step 2: Run repository knowledge/Skill validation**
...
- [x] **Step 3: Run final consistency checks**
